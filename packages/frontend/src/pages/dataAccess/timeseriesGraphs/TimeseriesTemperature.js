...
const TimeseriesTemperature = () => {
  ...
  const tableColumns = [
    ...
    { title: "Measured Temp f", field: "measured_temp_degf" },
    {
      title: "Rolling Two Hour Avg f",
      field: "temp_rolling_two_hour_avg_degf",
    },
    { title: "Daily Avg f", field: "temp_daily_avg_degf" },
    {
      title: "Rolling Seven Day Avg f",
      field: "temp_rolling_seven_day_avg_degf",
    },
    { title: "Measured Temp c", field: "measured_temp_degc" },
    // {
    //   title: "Rolling Two Hour Avg c",
    //   field: "temp_rolling_two_hour_avg_degc",
    // },
    // { title: "Daily Avg c", field: "temp_daily_avg_degc" },
    // {
    //   title: "Rolling Seven Day Avg c",
    //   field: "temp_rolling_seven_day_avg_degc",
    // },
    // {
    //   title: "Collect Gap",
    //   field: "collect_gap",
    //   render: (rowData) => {
    //     return dateFormatter(rowData.collect_gap, "MM/DD/YYYY, h:mm A");
    //   },
    // },
