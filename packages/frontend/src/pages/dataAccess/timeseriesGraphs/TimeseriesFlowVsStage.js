...
const TimeseriesFlowVsStage = () => {
  ...
  const tableColumns = [
    ...
    { title: "Stage FT", field: "stage_ft" },
    { title: "Rating Curve Applied", field: "rating_curve_applied" },
        ...
        datasets: [
          {
            ...
            data: filteredData.map((item) => item.stage_ft),
            borderWidth: 2,
            ...defaultStyle,
          },
          {
            ...
            <Panel>
              <AccordionDetails>
                <TableWrapper>
                  <Table
                    isLoading={isLoading}
                    label="Flow vs Stage Timeseries Table"
...
export default TimeseriesFlowVsStage;
