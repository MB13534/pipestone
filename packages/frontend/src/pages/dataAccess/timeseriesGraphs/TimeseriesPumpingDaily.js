...
const TimeseriesPumpingDaily = () => {
  ...
  const tableColumns = [
    ...
    { title: "Pumping GPM", field: "pumping_gpm" },
    { title: "Meter Reading", field: "meter_reading" },
    { title: "Bad Reading Flag", field: "bad_reading_flag" },
    { title: "Override Flag", field: "override_flag" },
    { title: "Fill Value", field: "fill_value" },
    { title: "Fill Flag", field: "fill_flag" },
